...
const CourseCard: FC<Props> = ({ course, isProfile }) => {
  return (
    ...
    >
      <div className="w-full h-[50vh] dark:bg-slate-500 dark:bg-opacity-20 backdrop-blur border dark:border-[#fffffff1d] border-[#00000015] dark:shadow-[bg-slate-700] rounded-lg p-3 shadow-sm dark:shadow-inner ">
        <Image
